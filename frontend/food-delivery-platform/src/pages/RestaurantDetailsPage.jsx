        ...
        const loadMenu = async () => {
            try {
                ...
                setMenu(
                    dishes.map(d => ({
                        ...d,
                        image: resolveDishImage(d, CategoryMap[d.category], d.name, restaurant.id),
                        imageUrl: d.imageUrl,
                        desc: d.description,
                                    ...
                                    {items.map((dish, i) => (
                                        ...
                                        >
                                            <Link to={`/dish/${dish.id}`} className="dish-card big">
                                                ...
                                                <img
                                                    src={resolveDishImage(dish, dish.category, dish.name, restaurant.id)}
                                                    alt={dish.name}
                                                    {...dishImgProps}
                                                    onError={(e) =>
                                                        handleImageError(
                                                            e,
                                                            resolveDishImage(null, dish.category, dish.name, restaurant.id)
                                                        )
                                                    }
                                                />
